      ...
      if (userMatch) {
        if (activeStr) {
          ...
          if (parts.length === 3) {
            ...
            if (activeDate < today) {
              setLoginError(`Masa berlaku akses Anda telah habis pada ${activeStr}. Silahkan hubungi Admin SAK-iDRG.`);
              setPassword('');
        ...
        setLoginError('Username atau Password tidak terdaftar. Silahkan hubungi Admin SAK-iDRG untuk mendapatkan akses.');
        setPassword('');
        setCaptchaVerified(false);
      }
    } catch (err) {
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl p-8">
            ...
            <div className="mt-6 text-center">
              ...
              <p className="text-white/20 text-[10px] mt-1">© 2026 SAK-iDRG Analytics Platform</p>
            </div>
          </div>
        </div>
      </div>
